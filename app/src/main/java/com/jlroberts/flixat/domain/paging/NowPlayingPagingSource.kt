...
class NowPlayingPagingSource(private val moviesApi: MoviesApi): PagingSource<Int, MovieListResult>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieListResult> {
        return try {
            ...
            val response = moviesApi.getNowPlaying(nextPageNumber, "en-US")
            LoadResult.Page(
